...
def parse_args():
    ...
    parser.add_argument('--dataset-root', type=str, default='/home/jiachao/data',
...
def train(net, train_data, val_data, eval_metric, ctx, args):
    ...
    optimizer_params = dict(wd=1e-5, lr_scheduler=args.lr, target_sparsity=0.8, pretrain_step=10000, sparse_step=100000, frequency=1000, keywords_no_sparse=['bias', 'beta', 'gamma', 'resnetv1b_conv0_weight', 'dense0_weight', 'centernet0_conv1_weight', 'centernet0_conv3_weight', 'centernet0_conv5_weight'], special_sparsity_dict={'conv1_weight': 0.7})

    trainer = gluon.Trainer(
                net.collect_params(), 'NadamSparse',
...
if __name__ == '__main__':
    sys.argv.extend([
        ...
        '--num-workers', '4',
        '--dataset', 'voc',
        '--dataset-root', '~/.mxnet/datasets',
        '--batch-size', '3',
        '--log-interval', '10',
        '--epochs', '140',
        '--lr-decay-epoch', '90,120',
        '--lr', '3.75e-4',
        '--wd', '0.00001',
        '--momentum', '0.9',
        '--wh-weight', '0.1',
